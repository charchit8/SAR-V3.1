...
def decision_gpt(summ_gpt,temp_file_path):
    ...
    if summ_gpt:
        ...
        1. There is an indication of suspicion due to customer details not marching on merchant invoice (Perform name entity recoginition to identify names,address).\n\n\
