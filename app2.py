    ...
    with col5_up:   
        ...
        if generate_button:
            ...
            if st.session_state['llm'] == "Closed-Source":
                ...
                1. Involvement of multiple individuals\suspect who might have used the card for transaction without customer's permission (based on to whom Invoice is billed) and whose details mismatch with customer details (Customer details can be identified from Cardholder Information) suggests that there is an indiaction of suspicion.\n\n\
