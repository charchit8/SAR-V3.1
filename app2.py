...
with col_d2:
    ...
    with col5_up:   
        ...
        2. There is an indication of suspicion with involvement of multiple individuals, mismatch of customer details such as name,address,phone number on merchant invoice. \n\n\
