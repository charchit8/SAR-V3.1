    ...
    with col5_up:   
        ...
        if generate_button:
            ...
            if st.session_state['llm'] == "Closed-Source":
                ...
                1. There is an indication of suspicion with mismatch of customer details on merchant invoice (Customer details can be identified from Cardholder Information)\n\n\
